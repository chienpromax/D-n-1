 ...
 * @author xuanc
 */
public class ChiTietSPFrom extends javax.swing.JDialog {
     ...
     */
    public ChiTietSPFrom(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("bẩng thanh toán");
   ...
   void deleteHD() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChiTietSPFrom dialog = new ChiTietSPFrom(new javax.swing.JFrame(), true);
